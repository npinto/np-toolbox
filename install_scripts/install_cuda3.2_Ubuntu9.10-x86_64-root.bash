...
CC=gcc-4.4 sh devdriver_3.2_linux_64_260.19.26.run --ui=none --no-questions --accept-license -X
...
sh ./cudatoolkit_3.2.16_linux_64_ubuntu10.04.run --noexec --target cudatoolkit/
...
sudo -u thor sh $TMP_DIR/gpucomputingsdk_3.2.16_linux.run --noexec --target cudasdk/
